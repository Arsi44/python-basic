...
class TestBlog(TestCase):
    @patch('main.Blog')  # Показываем, что будем работать в тесте с классом 'main.Blog
    def test_blog_posts(self, MockBlog):
        blog = MockBlog()
        # Прописываем возвращаемое начение из функции posts этого класса
        ...
        # Полцчаем это значение
        response = blog.posts()
        # Делаем утверждение касательно полученного значения
